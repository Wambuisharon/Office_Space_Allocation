...
class TestCreateRoom(unittest.TestCase):
    ...
    def test_office_allocation(self):
        ...
        self.assertIn(test_office_allocation, self.dojo.list_of_offices.occupants)
    ...
    def test_office_with_similar_names(self):
        ...
        self.assertEquals(test_office_with_similar_names, "Sorry. Room Spire already exists")
        
    def test_living_room_with_similar_names(self):
        test_living_room_with_similar_names = self.dojo.create_room("Tent", "Living_space")
        self.assertEquals(test_living_room_with_similar_names,"Sorry. Room Tent already exists" )
